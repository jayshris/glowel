            ...
            <div class="col-xl-12 theiaStickySidebar">
                <div class="contact-sidebar">
                    ...
                    <ul class="other-info">
                        ...
                        <li><span class="other-title">Office Location</span><span class="other-value"><?= $employee_data['office_location'] ?></span></li>
                        ...
                        <li><span class="other-title">Image</span><span class="other-value" style="margin-left:40px;"><div class="image-container12">
                        <?php if(!empty($employee_data['profile_image1'])){?>
                        <img  src="<?= base_url().$employee_data['profile_image1'] ?>" alt="Image 1" class="img12"><?php }?></div>
                        <div class="image-container12">
                        <?php if(!empty($employee_data['profile_image2'])){?>
                        <img src="<?= base_url().$employee_data['profile_image2'] ?>" alt="Image 2" class="img12">
                        <?php }?>
                        </div></span></li>
                        <li><span class="other-title">UPI ID:</span><span class="other-value"><?= $employee_data['upi_id'] ?></span></li>
                    </ul>	
                </div>
            </div>
            <!-- /Contact Sidebar -->
