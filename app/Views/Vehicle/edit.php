                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="radio"  name="owner" value="company" <?= $vehicle_data['owner'] === 'company' ? 'checked' : '' ?> required>  
                                <label for="owner" style="padding-right:15px">Company</label>
                                <input type="radio"  name="owner" value="onhire" <?= $vehicle_data['owner'] === 'onhire' ? 'checked' : '' ?> required>  
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="text" name="rc" class="form-control"  value="<?php
                                if(isset($vehicle_data)){
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="text" name="chassis" class="form-control"  value="<?php
                                if(isset($vehicle_data)){
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="text" name="engine" class="form-control"  value="<?php
                                if(isset($vehicle_data)){
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="number" name="km" class="form-control"  value="<?php
                                if(isset($vehicle_data)){
                                  echo $vehicle_data['km_reading_start'];
                                }
                                ?>" min="0" oninput="validateInteger(event)" required>
                                <?php
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                              <div class="form-wrap">
                                <input type = "checkbox" style="background-color: #5CB85C;" id="approve" class="form-check-input"  name="approve" <?php if(isset($vehicle_data)){
                                  if($vehicle_data['approved'] == 1){
                                        echo 'checked';
                                  } } ?> value="1"> 
                                  <label for="approve"><?php if(isset($vehicle_data)){ if($vehicle_data['approved'] == 1){ echo "Approved"; }else{ echo "Approve"; }}?></label> 
                              </div>
                            </div> 
                            <div class="col-md-6">
                              <div class="form-wrap">
