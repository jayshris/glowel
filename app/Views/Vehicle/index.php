                        ...
                        if($vehicle_data)
                        {
                            foreach($vehicle_data as $row)
                            {
                              ...
                              if(isset($row["updated_at"]) && ($row["updated_at"]!='0000-00-00 00:00:00')){
                                ...
                                <tr>
                                    <td>
                                    <a title="Edit" type="button" href="'.base_url().'vehicle/edit/'.$row['id'].'" class="btn btn-success btn-sm"><i class="ti ti-pencil"></i> </a>
                                    <a title="View" type="button" href="'.base_url().'vehicle/view/'.$row['id'].'" class="btn btn-primary btn-sm"><i class="ti ti-arrow-right"></i> </a>
