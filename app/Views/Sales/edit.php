                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-md-3">  
                              ...
                              <div id="upload_img_1">
                                ...
                                <img src="<?= base_url('public/uploads/sales/') . $order_details['image_1'] ?>" style="height: 150px;">
                                <?php } 
                            ...
                            <div class="col-md-3">
                              ...
                              <div id="upload_img_2">
                                ...
                                <img src="<?= base_url('public/uploads/sales/') . $order_details['image_2'] ?>" style="height: 150px;">
                                <?php } 
