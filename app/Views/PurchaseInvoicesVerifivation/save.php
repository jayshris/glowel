      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12"> 
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4 text-end">
                  <div class="head-icons">
                    <a href="<?= base_url('purchase-invoices-verifivation') ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="settings-form">  
                      <form method="post" enctype="multipart/form-data" id="invoices_form" action="<?php echo base_url('purchase-invoices-verifivation/save/'.$purchase_order_id.''); ?>">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('purchase/add-products/' . $token); ?>">
              <input type="hidden" name="purchase_invoice_verification_form" value="1"/>  
              <div class="card main-card">
                <div class="card-body">
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-7">
                      <a href="<?php echo base_url('/purchase-invoices-verifivation'); ?>" class="btn btn-warning mt-4">Reset</a>&nbsp;&nbsp;
                    </div>
                  </div> 
                  <!-- Product List -->
            ...
            <div class="card main-card"> 
              <div class="card-body">
                ...
                <a href="<?php echo base_url('/purchase-invoices-verifivation'); ?>" class="btn btn-light">Back</a>
              </div>  
            </div> 
  ...
  <script>
    ...
    function confirmcForm() {  
          if(confirm("Do you want to save?")){ 
            ...
            window.location.replace("<?= base_url('purchase-invoices-verifivation') ?>");
          } 
      }
   ...
   <script>
      ...
      $.confirm = function() {
        $.ajax({
          type: "GET",
          url: "<?= base_url('purchase/getOrderProducts/' . $token ) ?>",
          success: function(status) {
            if(status>0){
                if (confirm("Do you want to proceed?")) {
                  window.location.replace("<?= base_url('purchase/purchase-checkout/'. $token) ?>");   
                }
              }else{
