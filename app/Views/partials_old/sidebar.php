            ...
            <ul>
                <li>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class=""><i class="ti ti-brand-airtable"></i><span>Setup</span><span class="menu-arrow"></span></a>
                            <ul>
                                <li><a class="<?php echo ($page == 'company/create') ? 'active' : '' ;?>" href="<?php echo base_url(); ?>company/create">Add Company</a></li>
                                <li><a class="<?php echo ($page == 'company') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>company">Company Listing Screen</a></li>
                                <li><a class="<?php echo ($page == 'office/create') ? 'active' : '' ;?>" href="<?php echo base_url(); ?>office/create">Add Office</a></li>
                                <li><a class="<?php echo ($page == 'offfice') ? 'active' : '' ;?>" href="<?php echo base_url(); ?>office">Office Listing Screen</a></li>
                ...
                <li>
                    ...
                    <li class="submenu">
                            <a href=""
                                class="<?php echo ($page == 'user/index'|| $page =='user/create') ? 'subdrop active' : '' ;?>"><i
                                    class="ti ti-brand-airtable"></i><span>Party</span><span
                    ...
                    <li class="submenu">
                            <a href=""
                                class="<?php echo ($page == 'user/index'|| $page =='user/create') ? 'subdrop active' : '' ;?>"><i
                                    ...
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a class="<?php echo ($page == 'user/create') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>user/create">Add User</a></li>
                                        
                                <li><a class="<?php echo ($page == 'user/index') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>user/index">User Listing</a></li>
                                
                                <li><a class="<?php echo ($page == 'usertype/index') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>usertype/index">User Types</a></li>
                                <li><a class="<?php echo ($page == 'usertype/index') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>usertype/create">Add User Types</a></li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <li class="submenu">
                            <a href=""
                                class="<?php echo ($page == 'fueltype/index'|| $page =='fueltype/create') ? 'subdrop active' : '' ;?>"><i
                                    class="ti ti-brand-airtable"></i><span>Fuel Module</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                ...
                <li>
                    ...
                    <li class="submenu">
                            <a href=""
                                class="<?php echo ($page == 'vehicletype/index'|| $page =='vehicletype/create') ? 'subdrop active' : '' ;?>"><i
                                    class="ti ti-brand-airtable"></i><span>Vehicle Module</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                                ...
                                <li><a class="<?php echo ($page == 'vehicle') ? 'active' : '' ;?>" href="<?php echo base_url(); ?>vehicle">Vehicle</a></li>
                                <li><a class="<?php echo ($page == 'vehicle/create') ? 'active' : '' ;?>" href="<?php echo base_url(); ?>vehicle/create">Add Vehicle</a></li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <li class="submenu">
                            <a href="javascript:void(0);"
                                class="<?php echo ($page == 'driver') ? 'subdrop active' : '' ;?>"><i
                                    class="ti ti-brand-airtable"></i><span>Driver</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                ...
                <li>
                    ...
                    <li class="submenu">
                            <a href="javascript:void(0);"
                                class="<?php echo ($page == 'module') ? 'subdrop active' : '' ;?>"><i class="ti ti-brand-airtable"></i><span>Modules </span><span class="menu-arrow"></span></a>
                            <ul>
