                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="settings-form">
                      ...
                      <form action="<?php echo base_url(); ?>vehicletype/create" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-wrap">
                                ...
                                <input type="number" name="number_of_tyres" class="form-control"  value="<?= set_value('number_of_tyres') ?>" min="1" oninput="validateInteger(event)" pattern = "[1-9][0-9]{0,4}" required>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-wrap">
                                ...
                                <input type="text" name="unladen_weight" class="form-control"  pattern="^\d+(\.\d{0,2})?$"  value="<?= set_value('unladen_weight') ?>" title="Please enter a valid number with up to 2 decimal places." required>
