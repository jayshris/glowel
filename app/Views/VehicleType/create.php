                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="number" name="number_of_tyres" class="form-control"  value="<?= set_value('number_of_tyres') ?>">
                                <?php
                            ...
                            <div class="col-md-6">
                              <div class="form-wrap">
                                ...
                                <input type="number" name="unladen_weight" class="form-control"  value="<?= set_value('unladen_weight') ?>">
                                <?php
