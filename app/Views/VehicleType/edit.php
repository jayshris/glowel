                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-wrap">
                                ...
                                ?>" min="1" oninput="validateInteger(event)" pattern = "[1-9][0-9]{0,4}" required>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-wrap">
                                ...
                                <input type="text" name="unladen_weight" class="form-control"  pattern="^\d+(\.\d{0,2})?$" title="Please enter a valid number with up to 2 decimal places."    value="<?php
