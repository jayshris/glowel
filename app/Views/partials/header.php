...
<div class="header">
		...
		<ul class="nav user-menu">
			...
			<li class="nav-item dropdown nav-item-box">
				<a href="javascript:void(0);" class="nav-link" data-bs-toggle="dropdown">
					...
					<span class="badge rounded-pill"><?php echo count(getNotifications()); ?></span>
				</a>
				<div class="dropdown-menu dropdown-menu-end notification-dropdown">
					<div class="topnav-dropdown-header">
						<h4 class="notification-title">Notifications</h4>
					</div>
					<div class="noti-content notif">
						...
						?>
							...
							<!-- <li class="notification-message">
								<a href="<?php echo base_url(); ?>activities">
									<div class="media d-flex">
										<span class="avatar flex-shrink-0">
											<img src="<?php echo base_url(); ?>public/assets/img/profiles/avatar-03.jpg" alt="Profile">
										</span>
										<div class="media-body flex-grow-1">
				...
				<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
					<span class="user-info">
						<span class="user-letter">
							<img src="<?php echo base_url(); ?>public/assets/img/profiles/avatar-20.jpg" alt="Profile">
						</span>
	...
	<div class="dropdown mobile-user-menu">
		...
		<div class="dropdown-menu">
			...
			<a class="dropdown-item" href="<?php echo base_url(); ?>index">
				<i class="ti ti-lock"></i> Logout
			</a>
		</div>
	</div>
