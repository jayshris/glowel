      ...
      <div class="content">
        ...
        ?>
                ...
                <div class="filter-section filter-flex">
                 ...
                 <form method="post" action="<?php echo base_url() ?>searchByStatus" >
                      <!-- Search -->
                      <div class="search-section">
                        <div class="row">
                        ...
                        if($cModel)
                        {
                            foreach($cModel as $company)
                            {
                              ...
                              if($company['status'] == 'Active'){
                                $bun = '<a href="status/'.$company['id'].'" class="btn btn-danger btn-sm" role="button">Inactive</a>';
                              }else{
                                $bun = '<a href="status/'.$company['id'].'" class="btn btn-success btn-sm" role="button">Active</a>';
                              }
