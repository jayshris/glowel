 ...
 public $added_ip;
  ...
  public function index()
  {
    ...
    if ($access === 'false') {
      ...
      $data['employee_data'] = $this->employeeModel->orderBy('id', 'DESC')->paginate(10);
      $data['pagination_link'] = $this->employeeModel->pager;
      $data['page_data'] = ['page_title' => view('partials/page-title', ['title' => 'Employee', 'li_1' => '123', 'li_2' => 'deals'])];
  ...
  public function create()
  {
    ...
    if ($access === 'false') {
      ...
      helper(['form', 'url']);
      $data['page_data'] = ['page_title' => view('partials/page-title', ['title' => 'Add Employee', 'li_2' => 'profile'])];
  ...
  public function edit($id = null)
  {
    ...
    if ($access === 'false') {
      ...
      $data['employee_detail'] = $this->employeeModel->where('id', $id)->first();

      $data['company'] = $this->companyModel->where(['status' => 'Active'])->orderBy('name')->findAll();
      $data['office_data'] = $this->officeModel->where('id', $data['employee_detail']['branch_id'])->findAll();
  ...
  public function approve($id = null)
  {
    ...
    if ($access === 'false') {
      ...
      return view('Employee/approve', $data);
    }
  }
